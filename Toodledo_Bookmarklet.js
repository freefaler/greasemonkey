...
(function () {
    ...
    function taskAdded(a) {
        ...
        else if ("-1" == b)alert("Sorry, the task was not added because you are no longer signed in.  Please sign in and try again."), "quick" == e && top.postMessage("fail", "*");
        else if ("-6" == b)alert("Sorry, you have reached the maximum number of tasks allowed (20,000) per account. You will need to delete some old completed tasks to make room for more."),
    ...
    function FixFontSizes () {
      ...
      ttitle.style.fontSize = "14px";
      ttitle.style.width = "85%";
      // Task note
      var tnote = document.getElementById('addnote');
      tnote.style.fontSize = "14px";
    }
    FixFontSizes();
